...
export default function AuthOverlay() {
  ...
  return (
    <div
      id="AuthOverlay"
      className="fixed flex items-center justify-center z-50 left-0 top-0 w-full h-full bg-black bg-opacity-50"
    >
      <div className="relative bg-white w-full max-w-[470px] h-[70%] p-4 rounded-lg">
        ...
        {/* Ini component Login atau register */}
        {isRegister ? <Register /> : <Login />}

        {/* Opsi Login atau Register */}
        <div className="absolute flex items-center justify-center py-5 left-0 bottom-0 border-t w-full">
          <span className="text-[14px] text-gray-600">Don't have account?</span>
          <button
